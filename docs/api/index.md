...
| API | Use it for |
| --- | --- |
| [Scripting API](scripting-api.md) | The `linkiir.*` Lua calls available inside a node script — parsing messages, pushing to the next node, HTTP/SMTP/socket/file I/O, encoding, crypto, databases. |
