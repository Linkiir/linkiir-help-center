---
title: Feature Demo
description: A ready-to-run Linkiir project that generates HL7, moves it over LLP, stores patients in SQLite, and serves them back through a JSON API — a complete round trip built with the native scripting API.
keywords: [demo, HL7, LLP, SQLite, HTTP API, core nodes, getting started]
---
...
One of two [Demo Projects](demo-project.md). For a healthcare interoperability example, see the [HL7 v2 to FHIR Demo](demo-hl7v2-fhir.md).
...
| Goal | Read |
| --- | --- |
| Try the healthcare interoperability demo | [HL7 v2 to FHIR Demo](demo-hl7v2-fhir.md) |
