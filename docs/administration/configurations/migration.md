...
Use the adapter to get an interface working with minimal edits, then move to the native API as you touch each script. The complete name mapping is in [Linkiir Scripting API](../../interface-development/lua-programming/linkiir-api.md).
...
- [Linkiir Scripting API](../../interface-development/lua-programming/linkiir-api.md) — the legacy-to-native name mapping.
