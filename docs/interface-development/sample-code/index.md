...
Both samples use the native `linkiir.*` API. If you are migrating scripts from a legacy integration engine, the equivalent legacy names and how to enable them are in [Linkiir Scripting API](../../api/scripting-api/index.md).
